...
class Blstm(nn.Module):
    ...
    Attributes:
        ...
        frame_size (int): the size of frame in STFT setting 
	
        hidden_size (int): the hidden size of LSTM layer
	       
        bn : the batchnormalization layer for input feature
	
        lstm : the Blstm layer 
	    
        fc : the fully connected layer as output layer
